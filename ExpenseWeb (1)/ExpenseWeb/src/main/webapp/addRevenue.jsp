...
<%
List<Transaction> list1=(List<Transaction>)request.getSession().getAttribute("revenue_list1");
    ...
    <div class="container-fluid" style="height:100vh">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link  active  fs-5" href="#">Add Revenue</a>
                            </li>
        ...
        <div class="row  mt-3 bg-light " style="height:73vh">
            ...
            <div class="col-sm-12 col-md-6 col-lg-6 "" >
                ...
                <h2>Add Your Revenue</h2>
            </div>
            <div class="row justify-content-center  bg-light">
            <div class="col-8">
               <form action="addRevenue.app" onsubmit="return validation()">
                    ...
                    <select class="form-select " name="type" aria-label="Default select example">
                        ...
                        <br>
                        <div class="text-center">
                        <input class="btn btn-dark" type="submit" value="Add Revenue"/>
                    </div>
